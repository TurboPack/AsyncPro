...
// (DO NOT EDIT: machine generated header) 'AdPort.pas' rev: 28.00 (Windows)
...
protected:
	...
	unsigned FTraceSize;
	Oomisc::TPassString FTraceName;
	bool FTraceHex;
	bool FTraceAllHex;
	TTraceLogState FLogging;
	unsigned FLogSize;
	Oomisc::TPassString FLogName;
	bool FLogHex;
	bool FLogAllHex;
	bool FUseMSRShadow;
	bool FUseEventWord;
...
public:
	...
	__property Oomisc::TPassString TraceName = {read=FTraceName, write=FTraceName};
	...
	__property Oomisc::TPassString LogName = {read=FLogName, write=FLogName};
