...
// (DO NOT EDIT: machine generated header) 'OoMisc.pas' rev: 28.00 (Windows)
...
typedef BOOL __fastcall (*TCvtStatusCallback)(PAbsFaxCvt Cvt, System::Word StatFlags, int BytesRead, int BytesToRead);
...
extern DELPHI_PACKAGE BOOL __fastcall FlagIsSet(unsigned Flags, unsigned FlagMask);
...
extern DELPHI_PACKAGE BOOL __fastcall TimerExpired(const EventTimer &ET);
...
extern DELPHI_PACKAGE int __fastcall DelayTicks(int Ticks, BOOL Yield);
extern DELPHI_PACKAGE System::WideChar * __fastcall Long2StrZ(System::WideChar * Dest, int L);
extern DELPHI_PACKAGE BOOL __fastcall Str2LongZ(System::WideChar * S, int &I);
...
extern DELPHI_PACKAGE BOOL __fastcall ExistFileZ(System::UnicodeString FName)/* overload */;
