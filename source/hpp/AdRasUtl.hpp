...
// (DO NOT EDIT: machine generated header) 'AdRasUtl.pas' rev: 28.00 (Windows)
...
typedef BOOL __stdcall (*TRasDialDlg)(System::WideChar * lpszPhonebook, System::WideChar * lpszEntry, System::WideChar * lpszPhoneNumber, PRasDialDlgInfo lpDialDlgInfo);

typedef BOOL __stdcall (*TRasMonitorDlg)(System::WideChar * lpszDeviceName, PRasMonitorDlgInfo lpMonitorDlgInfo);

typedef BOOL __stdcall (*TRasPhonebookDlg)(System::WideChar * lpszPhonebook, System::WideChar * lpszEntry, PRasPhonebookDlgInfo lpPBDlgInfo);
...
typedef unsigned __stdcall (*TRasGetEntryDialParams)(System::WideChar * lpszPhonebook, PRasDialParams lpDialParams, BOOL &Password);

typedef unsigned __stdcall (*TRasSetEntryDialParams)(System::WideChar * lpszPhonebook, PRasDialParams lpDialParams, BOOL RemovePassword);
