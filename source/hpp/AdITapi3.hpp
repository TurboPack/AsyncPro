...
// (DO NOT EDIT: machine generated header) 'AdITapi3.pas' rev: 28.00 (Windows)
...
public:
	...
	virtual HRESULT __stdcall FindPin(System::_di_IInterface pSource, TPin_Direction pindir, System::PGUID pCategory, System::PGUID pType, BOOL fUnconnected, int num, /* out */ _di_IPin &ppPin) = 0 ;
};
