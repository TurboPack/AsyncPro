...
// (DO NOT EDIT: machine generated header) 'AwKermit.pas' rev: 28.00 (Windows)
...
extern DELPHI_PACKAGE int __fastcall kpGetLPStatus(Awtpcl::PProtocolData P, BOOL &InUse, unsigned &PacketSize);
