...
// (DO NOT EDIT: machine generated header) 'AwTPcl.pas' rev: 28.00 (Windows)
...
typedef BOOL __fastcall (*ReadProtProc)(PProtocolData P, TDataBlock &Block, unsigned &BlockSize);

typedef BOOL __fastcall (*WriteProtProc)(PProtocolData P, TDataBlock &Block, unsigned BlockSize);
