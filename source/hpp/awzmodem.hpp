...
// (DO NOT EDIT: machine generated header) 'AwZmodem.pas' rev: 28.00 (Windows)
...
extern DELPHI_PACKAGE int __fastcall zpSetFileMgmtOptions(Awtpcl::PProtocolData P, BOOL Override, BOOL SkipNoFile, System::Byte FOpt);
extern DELPHI_PACKAGE int __fastcall zpSetRecoverOption(Awtpcl::PProtocolData P, BOOL OnOff);
extern DELPHI_PACKAGE int __fastcall zpSetBigSubpacketOption(Awtpcl::PProtocolData P, BOOL UseBig);
