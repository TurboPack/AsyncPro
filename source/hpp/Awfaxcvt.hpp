...
// (DO NOT EDIT: machine generated header) 'AwFaxCvt.pas' rev: 28.00 (Windows)
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE BOOL __fastcall awIsAnAPFFile(System::UnicodeString FName);
...
extern DELPHI_PACKAGE BOOL __fastcall acOptionsAreOn(Oomisc::PAbsFaxCvt Cvt, System::Word OptionFlags);
extern DELPHI_PACKAGE void __fastcall acSetMargins(Oomisc::PAbsFaxCvt Cvt, unsigned Left, unsigned Top);
extern DELPHI_PACKAGE void __fastcall acSetResolutionMode(Oomisc::PAbsFaxCvt Cvt, BOOL HiRes);
...
extern DELPHI_PACKAGE int __fastcall acGetRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
extern DELPHI_PACKAGE int __fastcall acAddData(Oomisc::PAbsFaxCvt Cvt, void *Buffer, unsigned Len, BOOL DoInc);
...
extern DELPHI_PACKAGE int __fastcall acOutToFileCallback(Oomisc::PAbsFaxCvt Cvt, void *Data, int Len, BOOL EndOfPage, BOOL MorePages);
...
extern DELPHI_PACKAGE int __fastcall fcLoadFont(Oomisc::PAbsFaxCvt Cvt, char * FileName, unsigned FontHandle, BOOL HiRes);
...
extern DELPHI_PACKAGE int __fastcall fcGetTextRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE int __fastcall tcGetTiffRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE int __fastcall pcGetPcxRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE int __fastcall dcGetDcxRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE int __fastcall bcGetBmpRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE int __fastcall bcGetBitmapRasterLine(Oomisc::PAbsFaxCvt Cvt, void *Data, int &Len, BOOL &EndOfPage, BOOL &MorePages);
...
extern DELPHI_PACKAGE BOOL __fastcall upOptionsAreOn(Oomisc::PUnpackFax Unpack, System::Word OptionFlags);
...
extern DELPHI_PACKAGE int __fastcall upUnpackPageToBitmap(Oomisc::PUnpackFax Unpack, System::UnicodeString FName, unsigned Page, Oomisc::TMemoryBitmapDesc &Bmp, BOOL Invert);
extern DELPHI_PACKAGE int __fastcall upUnpackFileToBitmap(Oomisc::PUnpackFax Unpack, System::UnicodeString FName, Oomisc::TMemoryBitmapDesc &Bmp, BOOL Invert);
