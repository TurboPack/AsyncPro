...
// (DO NOT EDIT: machine generated header) 'AwAbsPcl.pas' rev: 28.00 (Windows)
...
extern DELPHI_PACKAGE BOOL __fastcall apNextFileMask(Awtpcl::PProtocolData P, char * FName);
extern DELPHI_PACKAGE BOOL __fastcall apNextFileList(Awtpcl::PProtocolData P, char * FName);
...
extern DELPHI_PACKAGE BOOL __fastcall apSupportsBatch(Awtpcl::PProtocolData P);
...
extern DELPHI_PACKAGE BOOL __fastcall apOptionsAreOn(Awtpcl::PProtocolData P, unsigned OptionFlags);
extern DELPHI_PACKAGE void __fastcall apStartProtocol(Awtpcl::PProtocolData P, System::Byte Protocol, BOOL Transmit, Awtpcl::TPrepareProc StartProc, Awtpcl::TProtocolFunc ProtFunc);
...
extern DELPHI_PACKAGE BOOL __fastcall aapReadProtocolBlock(Awtpcl::PProtocolData P, Awtpcl::TDataBlock &Block, unsigned &BlockSize);
...
extern DELPHI_PACKAGE BOOL __fastcall aapWriteProtocolBlock(Awtpcl::PProtocolData P, Awtpcl::TDataBlock &Block, unsigned BlockSize);
...
extern DELPHI_PACKAGE BOOL __fastcall apMsgNextFile(Awtpcl::PProtocolData P, char * FName);
extern DELPHI_PACKAGE void __fastcall apMsgLog(Awtpcl::PProtocolData P, unsigned Log);
extern DELPHI_PACKAGE BOOL __fastcall apMsgAcceptFile(Awtpcl::PProtocolData P, char * FName);
