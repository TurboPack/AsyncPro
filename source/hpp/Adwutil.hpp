...
// (DO NOT EDIT: machine generated header) 'AdWUtil.pas' rev: 28.00 (Windows)
...
typedef BOOL __stdcall (*TfnTransmitFile)(int hSocket, NativeUInt hFile, unsigned nNumberOfBytesToWrite, unsigned nNumberOfBytesPerSend, Winapi::Windows::POverlapped lpOverlapped, PTransmitFileBuffers lpTransmitBuffers, unsigned dwReserved);
