...
Begin VB.Form Form1 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbxProtocol 
         Height          =   315
         ItemData        =   "ExPStat.frx":0000
         Left            =   1560
         List            =   "ExPStat.frx":0022
...
Private Sub Apax1_OnProtocolFinish(ByVal ErrorCode As Long)
  ...
  Else
    Apax1.TerminalWriteStringCRLF (Apax1.SendFileName + " protocol error.")
  End If
End Sub

Private Sub Apax1_OnProtocolStatus(ByVal Options As Long)
  If (Options <> 1) And (Options <> 2) Then
    lblFileName.Caption = Apax1.SendFileName
    lblBytesTransferred = Apax1.BytesTransferred
    lblBytesRemaining = Apax1.BytesRemaining
  End If
End Sub
...
Private Sub Apax1_OnTapiPortClose()
  Caption = "ExSend - File Transfer Sender with Status"
...
Private Sub btnSend_Click()
  ...
  Apax1.SendFileName = CommonDialog1.FileName
  Apax1.Protocol = cbxProtocol.ListIndex
  Caption = "Sending " + File1.FileName
  Apax1.StartTransmit
  Exit Sub
DoCancel:
  Exit Sub
