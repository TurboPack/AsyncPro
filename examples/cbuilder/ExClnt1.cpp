...
{
  if (ApdWinsockPort1->WsAddress == "") {
  // get the address from the WsLocalAddresses list
    ApdWinsockPort1->WsAddress =
      ApdWinsockPort1->WsLocalAddresses->Strings[ApdWinsockPort1->WsLocalAddressIndex];
  }
}
//---------------------------------------------------------------------------
